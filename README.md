...
```
```bash
git clone https://github.com/mouratsm/izingautoinstalador.git izinginstalador
```
...
Para quem gostaria de uma consultoria ou que eu faça instalação pode chamar no whatsapp 
